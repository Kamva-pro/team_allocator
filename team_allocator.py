...
def dbn_physical_students(dbn_students):
    ...
    for i in dbn_students:
        if "Physical" in i:
            dbn_physical_students_list.append(i)

    return dbn_physical_students_list

def create_team(team, list, index):
    team = list[index:index+4]
    return team
...
def dbn_physical_teams(dbn_physical_students):
    ...
    length = len(dbn_physical_students)

    team = []
    for i in range(0,length,4):
        print(create_team(team, dbn_physical_students, i))
